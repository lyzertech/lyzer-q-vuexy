...
@section('content')
    ...
    {{-- <div class="modal-onboarding modal fade animate_animated" id="ModalAddVisit" tabindex="-1" style="display: none;"
        aria-hidden="true">
        ...
        <div class="offcanvas-body mx-0 flex-grow-0">
            <form method="post" action="{{ route('quot.create') }}" enctype="multipart/form-data"
                ...
                <div class="mb-3 fv-plugins-icon-container">
                    ...
                    <input type="number" class="form-control" id="add-user-qty" placeholder="quantity" name="qty"
                        aria-label="qty">
                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content text-center">
                ...
                <div class="modal-body onboarding-horizontal p-0">
                    <div class="onboarding-media">
                        <img src="sneat/assets/img/illustrations/boy-verify-email-light.png" alt="boy-verify-email-light"
