...
@section('content')
    ...
    <div class="row g-6">
        ...
        <!-- Sales Visit Report (Last 30 Days) -->
        <div class="col-xl-3 col-sm-6">
            <div class="card h-100">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <p class="mb-0 text-body">Sales Visit Report (Last 30 Days)</p>
                        <p class="card-text fw-medium text-success">+(raise fr last 30)%</p>
                    </div>
                    <h4 class="card-title mb-1">(Total visit 30 days)</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-4">
                            ...
                            <small class="text-muted">(Total visit SEP)</small>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="col-4 text-end">
                            ...
                            <small class="text-muted">(Total visit AII)</small>
                        </div>
                    </div>
            ...
            <div class="card h-100">
                <div class="card-header pb-0 d-flex justify-content-between">
                    <div class="card-title mb-0">
                        <h5 class="mb-1">Visit Reports</h5>
