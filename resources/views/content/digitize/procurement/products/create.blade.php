...
@section('title', 'Add New Product - Procurement')
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mt-1 mb-0">Create a new product for procurement management</p>
                </div>
            ...
            <form action="{{ route('procurement.products.store') }}" method="POST" id="productForm">
                @csrf
                <div class="card-body">
                    <div class="row g-4">
                        <!-- Basic Information -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text">Leave empty to auto-generate based on product name</div>
                            @error('product_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('specifications') is-invalid @enderror" 
                                      ...
                                      placeholder="Enter detailed product specifications, features, and technical details">{{ old('specifications') }}</textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('unit_of_measure') is-invalid @enderror" id="unit_of_measure" name="unit_of_measure">
                                <option value="PCS" {{ old('unit_of_measure', 'PCS') === 'PCS' ? 'selected' : '' }}>PCS (Pieces)</option>
                                ...
                                <option value="M2" {{ old('unit_of_measure') === 'M2' ? 'selected' : '' }}>M² (Square Meter)</option>
                                <option value="M3" {{ old('unit_of_measure') === 'M3' ? 'selected' : '' }}>M³ (Cubic Meter)</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('primary_supplier') is-invalid @enderror" id="primary_supplier" name="primary_supplier">
                                ...
                                @foreach($suppliers ?? [] as $supplier)
                                    <option value="{{ $supplier->id_supplier }}" {{ old('primary_supplier') == $supplier->id_supplier ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('lead_time_days') is-invalid @enderror" 
                                   id="lead_time_days" name="lead_time_days" value="{{ old('lead_time_days', 7) }}" 
                                   min="1" placeholder="7">
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_serialized" name="is_serialized" 
                                       value="1" {{ old('is_serialized') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_hazardous" name="is_hazardous" 
                                       value="1" {{ old('is_hazardous') ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    nameInput.addEventListener('input', function() {
        if (!codeInput.value || codeInput.hasAttribute('data-auto-generated')) {
            const code = generateProductCode(this.value);
...
function generateProductCode(name) {
    ...
    // Limit to 8 characters and add random numbers if needed
    if (code.length > 6) {
