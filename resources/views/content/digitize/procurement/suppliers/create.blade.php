        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mt-1 mb-0">Create a new supplier profile for procurement management</p>
                </div>
            ...
            <form action="{{ route('procurement.suppliers.store') }}" method="POST" id="supplierForm">
                @csrf
                <div class="card-body">
                    <div class="row g-4">
                        <!-- Basic Information -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text">Leave empty to auto-generate based on supplier name</div>
                            @error('supplier_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                      ...
                                      placeholder="Complete address including city and postal code">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('products_services') is-invalid @enderror" 
                                   id="products_services" name="products_services" value="{{ old('products_services') }}" 
                        ...
                        <div class="col-md-4">
                            <label class="form-label" for="performance_score">Initial Performance Score (%)</label>
                            <input type="number" class="form-control @error('performance_score') is-invalid @enderror" 
                                   id="performance_score" name="performance_score" value="{{ old('performance_score', 80) }}" 
                                   min="0" max="100" step="0.1">
                            <div class="form-text">Starting performance score (0-100)</div>
                        ...
                        <div class="col-md-4">
                            <div class="form-check mt-4 pt-2">
                                <input class="form-check-input" type="checkbox" id="can_dropship" name="can_dropship" 
                                       value="1" {{ old('can_dropship') ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    nameInput.addEventListener('input', function() {
        if (!codeInput.value || codeInput.hasAttribute('data-auto-generated')) {
            const code = generateSupplierCode(this.value);
...
function generateSupplierCode(name) {
    ...
    // Limit to 10 characters and add random numbers if needed
    if (code.length > 6) {
