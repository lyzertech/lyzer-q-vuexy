    ...
    <div class="row g-6">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="row row-bordered g-0">
                    <div class="col-sm-6 p-6">
                        <div class="text-light small fw-medium mb-4">Default with icon</div>
                        <label class="switch">
                            <input type="checkbox" class="switch-input" />
                            <span class="switch-toggle-slider">
                    ...
                    <div class="col-sm-6 p-6">
                        <div class="text-light small fw-medium mb-4">Square with icon</div>
                        <label class="switch switch-square">
                            <input type="checkbox" class="switch-input" />
                            <span class="switch-toggle-slider">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="row row-bordered g-0">
                    <div class="col-sm-6 p-6">
                        <div class="text-light small fw-medium">Disabled</div>
                        <div class="demo-vertical-spacing">
                            <label class="switch">
                    ...
                    <div class="col-sm-6 p-6">
                        <div class="text-light small fw-medium">Validation states</div>
                        <div class="demo-vertical-spacing">
                            <label class="switch">
