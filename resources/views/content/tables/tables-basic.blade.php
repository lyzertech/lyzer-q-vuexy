        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    <tr>
                        <td><i class="ti ti-brand-angular ti-md text-danger me-4"></i> <span class="fw-medium">Angular
                                Project</span></td>
                        <td>Albert Cook</td>
                        <td>
                    ...
                    <tr>
                        <td><i class="ti ti-brand-react-native ti-md text-info me-4"></i> <span class="fw-medium">React
                                Project</span></td>
                        <td>Barry Hunter</td>
                        <td>
                            <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                    ...
                    <tr>
                        <td><i class="ti ti-brand-vue ti-md text-success me-4"></i> <span class="fw-medium">VueJs
                                Project</span></td>
                        <td>Trevor Baker</td>
                        <td>
                            <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                    ...
                    <tr>
                        <td><i class="ti ti-brand-bootstrap ti-md text-primary me-4"></i> <span
        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-dark">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        <td class="rounded-start-bottom"><i class="ti ti-brand-bootstrap ti-md text-primary me-4"></i>
        ...
        <div class="card-body">
            <div class="table-responsive text-nowrap">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td><i class="ti ti-brand-angular ti-md text-danger me-4"></i> <span
                        ...
                        <tr>
                            <td><i class="ti ti-brand-react-native ti-md text-info me-4"></i> <span
            ...
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    <tr class="table-default">
                        <td><i class="ti ti-brand-sketch ti-md text-warning me-3"></i> <span class="fw-medium">Sketch
                                Project</span></td>
                        <td>Ronnie Shane</td>
                        <td>
                            <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                    ...
                    <tr class="table-info">
                        <td><i class="ti ti-brand-bootstrap ti-md text-primary me-4"></i> <span class="fw-medium">Latest
                                Bootstrap</span></td>
                        <td>Perry Parker</td>
                        <td>
                            <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                    ...
                    <tr class="table-dark">
                        <td class="rounded-start-bottom"><i class="ti ti-brand-vue ti-md text-success me-4"></i> <span
    ...
    <div class="table-responsive text-nowrap">
        <table class="table card-table">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    <td><i class="ti ti-brand-bootstrap ti-md text-primary me-4"></i> <span class="fw-medium">Bootstrap
                            Project</span></td>
                    <td>Jerry Milton</td>
                    <td>
                        <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
